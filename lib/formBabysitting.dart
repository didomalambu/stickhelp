...
class FormBabySitting extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _FormBabySittingState();
}
...
class _FormBabySittingState extends State<FormBabySitting> {
  ...
  Widget build(BuildContext context) {
   ...
   /// print (myLocale.toString());
    ...
    return new Scaffold(
      ...
      appBar: new AppBar(
        title: new Text('Babysitting',style: TextStyle(fontFamily: "sans-serif-condensed",fontSize: 20.0,fontWeight: FontWeight.bold
        ),),
                  ...
                  child: new ListView(
                    ...
                    children: <Widget>[
                      ...
                      new Padding(
                        ...
                        Row(children: <Widget>[
                          SizedBox(width: 100.0,
                            child:Text("TIME START",style: TextStyle(fontSize: 17.0,fontWeight: FontWeight.bold),),),
                          Padding(padding: EdgeInsets.fromLTRB(20.0, 10.0, 0, 10),
                            child: GestureDetector(
                      ...
                      new Padding(padding: new EdgeInsets.only(left: 15.0,right: 60.0,top: 10.0),
                        child: new Divider(color: Color.fromRGBO(58, 66, 86, 1.0),),
                      ),
                      new Padding(
                        padding: new EdgeInsets.only(left:20.0,right: 30.0),
                        ...
                        Row(children: <Widget>[
                          SizedBox(width: 100.0,
                            child:Text("TIME END",style: TextStyle(fontSize: 17.0,fontWeight: FontWeight.bold),), ),
                          Padding(padding: EdgeInsets.fromLTRB(20.0, 10.0, 0, 10),
                            child: GestureDetector(
                              //child:  Text("To       "+_timeEnd.toString(),style:  TextStyle(color: Color.fromRGBO(58, 66, 86, 1.0),fontSize: 18.0,),),
                              child: Row(children: <Widget>[
                                SizedBox(child: Text("To",style:  TextStyle(color: Color.fromRGBO(58, 66, 86, 1.0),fontSize: 18.0,),),width: 70.0,),
                                Text(_time.toString(),style:  TextStyle(color: Color.fromRGBO(58, 66, 86, 1.0),fontSize: 18.0,),)
                              ],),

                              onTap:(){
                                _selectTime(context,"timeEnd");
                              } ,) ,
                          )
                        ],),
                      ),
                      ...
                      new Row(
                        children: <Widget>[
                          new Padding(padding: new EdgeInsets.only(left:20.0,right: 30.0),
                            child:
                            //new Icon(Icons.place,size: 25.0,color:Color.fromRGBO(58, 66, 86, 1.0),),
                            Text("CHILDREN",style: TextStyle(fontSize: 17.0,fontWeight: FontWeight.bold),),
                          ),
                      ...
                      new Padding(padding: new EdgeInsets.only(left: 15.0,right: 60.0,top: 10,bottom: 10.0),
                        child: new Divider(color: Color.fromRGBO(58, 66, 86, 1.0),),
                      ),
                      GestureDetector(
                        child: new Row(
